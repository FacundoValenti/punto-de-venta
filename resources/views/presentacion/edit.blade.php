...
@section('content')
    <div class="container-fluid px-4">
        ...
        <div class="container w-100 border border-3 border-primary rounded p-4 mt-3">
            ...
            <form action="{{ route('presentaciones.update', ['presentacione' => $presentacione->id]) }}" method="post">
                @method('PATCH')
                @csrf
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="nombre" id="nombre" class="form-control" value="{{ old('nombre', optional($presentacione->caracteristica)->nombre ?? '') }}">
                        @error('nombre')
                    ...
                    <div class="col-md-12">
                        ...
                        <textarea name="descripcion" id="descripcion" rows="3" class="form-control">{{ old('descripcion', optional($presentacione->caracteristica)->descripcion ?? '') }}</textarea>
                    </div>
